"""
Calls Gemini to score/match tenders against a company profile.

Design choice: we ask Gemini to return ONLY {id, score, reasons,
...
# NOTE: gemini-2.5-flash has been retired by Google (Sep 2026) — new
# projects can no longer use it. gemini-3.6-flash is the current
# recommended replacement and works with this same generate_content()
# call. If this model also stops working later, check
# https://ai.google.dev/gemini-api/docs/models for the current name and
# set GEMINI_MODEL in your .env — no code changes needed.

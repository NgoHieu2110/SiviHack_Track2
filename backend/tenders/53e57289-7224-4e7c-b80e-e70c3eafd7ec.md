...
**Value (as matched):** 975,251.75 EUR
**CPV codes (as matched):** 90000000
**Region(s) (as matched):** DE300, DE914, DE929, DEA22
**Published:** 2026-09-16T02:06:26Z
**Notice ID:** 53e57289-7224-4e7c-b80e-e70c3eafd7ec
**OCID:** ocds-mnwr74-2ebc344d-4cdf-4f67-aca4-dcc33a54b61c
...
|---|---|---|
| `tender.lots` | Per-lot breakdown (value/CPV/region can differ from tender-level) | list of 1 item(s), first: `{"id": "LOT-0000", "title": "RV Fahrbahnreinigung nach Unfällen, AM Braunschweig-Hafen", "description": "Der Autobahn GmbH des Bundes, vertreten durch die Niederlassung Nordwest, Außenstelle Hannover ist mit ihren Autobahnmeistereien durch die Planung, den Bau und die Unterhaltung maßgeblich für die` |
...
| `tender.items` | Item list (CPV classification lives here today) | list of 1 item(s), first: `{"id": "LOT-0000", "classification": {"scheme": "CPV", "id": "90000000", "description": "Sewage, refuse, cleaning and environmental services"}, "deliveryLocation": {"description": "Bezirk von Autobahnmeisterei Braunschweig-Hafen"}, "deliveryAddress": {"streetAddress": "Hafenstr. 100", "locality": "S` |
...
{
  "ocid": "ocds-mnwr74-2ebc344d-4cdf-4f67-aca4-dcc33a54b61c",
  "id": "53e57289-7224-4e7c-b80e-e70c3eafd7ec",
  "date": "2026-09-16T02:06:26Z",
  "tag": [
    "tender"
  ],
  ...
  "tender": {
    "id": "2ebc344d-4cdf-4f67-aca4-dcc33a54b61c",
    "title": "RV Fahrbahnreinigung nach Unfällen, AM Braunschweig-Hafen",
    "description": "RV Fahrbahnreinigung nach Unfällen, AM Braunschweig-Hafen",
    "procuringEntity": {
      "name": "Die Autobahn GmbH des Bundes - NL Nordwest",
      "id": "USt-ID DE329214156"
    },
    "items": [
      {
        ...
        "deliveryLocation": {
          "description": "Bezirk von Autobahnmeisterei Braunschweig-Hafen"
        },
        "deliveryAddress": {
          "streetAddress": "Hafenstr. 100",
          "locality": "Schwülper",
          "region": "DE914",
          "postalCode": "38179",
          "countryName": "DEU"
    ...
    "documents": [
      {
        "id": "DOC-0001",
        "url": "https://vergabe.autobahn.de/NetServer/TenderingProcedureDetails?function=_Details&TenderOID=54321-Tender-1a061d3a7d5-5b7dbb94eb03bfea",
        "language": "DEU",
        "relatedLots": [
          "LOT-0000"
        ]

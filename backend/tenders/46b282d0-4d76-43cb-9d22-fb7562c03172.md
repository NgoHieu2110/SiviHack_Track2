# Neubau Feuerwehrhaus der Stadt Rietberg - Brandmeldeanlage

**Matched company:** company
**Buyer:** Stadt Rietberg
**Value (as matched):** 82,090.85 EUR
**CPV codes (as matched):** 45312100, 45312100, 31625200
**Region(s) (as matched):** DEA33, DEA42
**Published:** 2026-09-09T02:20:30Z
**Notice ID:** 46b282d0-4d76-43cb-9d22-fb7562c03172
**OCID:** ocds-mnwr74-7b227cd3-888d-4c1c-8c8b-390cc129c41c
...
|---|---|---|
| `tender.lots` | Per-lot breakdown (value/CPV/region can differ from tender-level) | list of 1 item(s), first: `{"id": "LOT-0001", "title": "Brandmeldeanlage", "description": "Das Gebäude wird mit einer automatischen Brandmeldeanlage als Vollschutz nach Kategorie K1 ausgestattet. Die Brandmeldeanlage dient der frühzeitigen Erkennung von Bränden und der unverzüglichen Alarmierung der anwesenden Personen sowie ` |
...
| `tender.items` | Item list (CPV classification lives here today) | list of 1 item(s), first: `{"id": "LOT-0001", "classification": {"scheme": "CPV", "id": "45312100", "description": "Fire-alarm system installation work"}, "additionalClassifications": [{"scheme": "CPV", "id": "45312100", "description": "Fire-alarm system installation work"}, {"scheme": "CPV", "id": "31625200", "description": ` |
...
{
  "ocid": "ocds-mnwr74-7b227cd3-888d-4c1c-8c8b-390cc129c41c",
  "id": "46b282d0-4d76-43cb-9d22-fb7562c03172",
  ...
  "tender": {
    "id": "7b227cd3-888d-4c1c-8c8b-390cc129c41c",
    "title": "Neubau Feuerwehrhaus der Stadt Rietberg - Brandmeldeanlage",
    "description": "Das Gebäude wird mit einer automatischen Brandmeldeanlage als Vollschutz nach Kategorie K1 ausgestattet. Die Brandmeldeanlage dient der frühzeitigen Erkennung von Bränden und der unverzüglichen Alarmierung der anwesenden Personen sowie der zuständigen hilfeleistenden Stelle.",
    "procuringEntity": {
      "name": "Stadt Rietberg",
      "id": "t:052449860"
    },
    ...
    "documents": [
      {
        "id": "DOC-0001",
        "url": "https://www.subreport.de/E49896899",
        "language": "DEU",
        "relatedLots": [
          "LOT-0001"
        ]
